...
ann_file = '/lustre06/project/6071878/saf10/pyskl_2/data/ntu60_hrnet.pkl'
train_pipeline = [
...
# optimizer
optimizer = dict(type='SGD', lr=0.05, momentum=0.9, weight_decay=0.0005, nesterov=True) #(lr=0.1)
...
# runtime settings
log_level = 'INFO'
work_dir = '/lustre06/project/6071878/saf10/work_dirs/msg3d/msg3d_pyskl_ntu60_xsub_hrnet_StaticConvNextTCN/b'
